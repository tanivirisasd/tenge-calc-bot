...
def handle_message(message):
    ...
    if 'гарп' in text:
        phrases = [
            "Это который по голосу на чеченца похож? @jjillee",
            "Это у которого голос как у чеченца? @jjillee",
            "Это который говорит, как чеченец? @jjillee",
            "Это который по голосу чеченец, а сам хуй пойми кто? @jjillee",
            "Это у которого голос чеченский, а сам он непонятно кто? @jjillee",
        ]
        bot.reply_to(message, random.choice(phrases))
        return
    ...
    if re.search(r'руб', text) or '₽' in text:
        ...
        answer = (
            ...
            f"😄  _{joke}_\n"
            f"⚡  _А во время золотой елды курс был вообще другой!_\n"
            "━━━━━━━━━━━━━━━━━━"
        )
